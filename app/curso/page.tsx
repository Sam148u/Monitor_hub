...
export default function CoursePage() {
  return (
    <section className="min-h-screen bg-[radial-gradient(circle_at_top_right,rgba(0,102,204,0.1),transparent_30%),#09090b] px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
          <div className="lg:sticky lg:top-28">
            ...
            <div className="glass-panel mt-7 rounded-2xl p-5">
              <Target className="size-6 text-blue-500" aria-hidden="true" />
